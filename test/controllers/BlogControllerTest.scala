    ...
    "should display the 'Building a 3D Renderer From Scratch Part 1: TGA Images' blog post" in {
      ...
      bodyText.replaceAll(" +", "") mustBe
        """<!DOCTYPE html>
          ...
          |</code></pre>
          |<p>
          |    &emsp;&emsp;Note the withAndUnion field. That's to make it so you can either input 4 defined chars, 4 raw chars, or simply define a single int value all in the same field without allocating more memory than necessary. Now just like
          ...
          |</code></pre>
          |<p>
          |    &emsp;&emsp;And now let's make constructors for our 3 different types in the withAndUnion:
          |</p>
          |<pre><code>
